...
NTracks = plotInfo(name="selTrksNbr_3D", 
...
distToJetAxis = plotInfo(name="jetDist_3D", 
                         title="track distance to the jet axis", 
                         legend="isVAL KEY-jets", 
                         Xlabel="distance to the jet axis [cm]", 
                         Ylabel="Arbitrary units",
                         logY=False, grid=False,
                         binning=None, Rebin=None, 
                         doNormalization=True, 
...
NHits = plotInfo(name="tkNHits_3D", 
...
NPixelHits = plotInfo(name="tkNPixelHits_3D", 
...
NormChi2 = plotInfo(name="tkNChiSqr_3D", 
...
jetNSecondaryVertices = plotInfo(name="jetNSecondaryVertices", 
...
trackSumJetEtRatio = plotInfo(name="trackSumJetEtRatio",
                              title="track sum Et / jet energy",
                              legend="isVAL KEY-jets",
                              Xlabel="track sum Et / jet energy",
                              Ylabel="Arbitrary units",
                              logY=False, grid=False,
                              binning=None, Rebin=None,
                              doNormalization=True,
